...
<html lang="en">
  ...
  <div class="form-group mx-sm-3 mb-2">
    ...
    <input type="number" class="form-control" id="item_id" name="item_id" placeholder="item_id">
  </div>
  <div class="form-group mx-sm-3 mb-2">
  ...
  <div class="form-group mx-sm-3 mb-2">
    ...
    <input type="text" class="form-control" id="item_price" name='item_price' placeholder="item_price">
  </div>
  <button type="submit" name='add' value='add' class="btn btn-primary mb-2">Add Item</button>
</form>
...
<?php
$Sql2 = "SELECT itemID, itemNAME, itemPRICE FROM item";
...
if($result2-> num_rows > 0 ){
  ...
  while($row = $result2->fetch_assoc()) {
    ...
    echo  "<td><a href='delet.php?id=". $row['itemID']."'>delete</a></td>";
    echo ' </tr>';
}
} else {
echo "0 results";
